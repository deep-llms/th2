#!/bin/bash
# Train Qwen3-0.6B from scratch — V1 embedding (V0 + context-dependent aggregation)
...
accelerate launch train_compositional.py \
    ...
    --report_to wandb \
    --output_dir /opt/dlami/nvme/sparse_emb_outputs/v1_content \
    --run_name v1-content-qwen3-0.6b \
    --arm v1 \
    --K 4096 \
    --d_x 128 \
    --d_k 64 \
