#!/bin/bash
# Train Qwen3-0.6B from scratch — Residual ANT embedding (identity + codebook)
...
accelerate launch train_compositional.py \
    ...
    --report_to wandb \
    --output_dir /opt/dlami/nvme/sparse_emb_outputs/residual_ant_tied \
    --run_name residual-ant-tied-qwen3-0.6b \
    --arm residual_ant \
    --K 4096 \
    --d_x 128 \
    --d_k 64 \
