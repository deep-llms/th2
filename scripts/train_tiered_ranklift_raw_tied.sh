#!/bin/bash
# Tiered RankLift: original raw-frequency GroupReduce allocation plus identical lifts.
...
TASK_OUTPUT_DIR="$TASK_OUTPUT_BASE/tiered_ranklift_raw_t4_c512"
...
"$TASK_PYTHON" -m accelerate.commands.launch train_compositional.py \
    ...
    --run_name tiered-ranklift-raw-t4-c512-qwen3-0.6b \
    --arm tiered_ranklift \
