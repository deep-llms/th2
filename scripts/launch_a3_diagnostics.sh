...
TASK_SESSION=ccm_a3_diagnostics_20260914_a01
TASK_LOG=/mnt/local/_outputs/deep-llms_th2/ccm_a3_seed17_20260914_a01.handoff.log
test ! -e "$TASK_LOG"
test ! -L "$TASK_LOG"
test ! -e /mnt/local/_outputs/deep-llms_th2/ccm_a3_seed17_20260914_a01
test ! -L /mnt/local/_outputs/deep-llms_th2/ccm_a3_seed17_20260914_a01
...
printf -v TASK_CMD 'cd /mnt/local/deep-llms_th2 && source /mnt/local/conda-py311/etc/profile.d/conda.sh && conda activate train_env && exec /usr/bin/python3 -u scripts/pilot_a3_diagnostics.py >%q 2>&1' "$TASK_LOG"
...
tail -n 30 "$TASK_LOG"
echo CCM_A3_DIAGNOSTICS_HANDOFF_ALIVE
