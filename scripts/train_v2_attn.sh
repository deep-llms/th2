#!/bin/bash
# Train Qwen3-0.6B from scratch — V2-attn embedding (context-conditioned selection)
...
accelerate launch train_compositional.py \
    ...
    --report_to wandb \
    --output_dir /opt/dlami/nvme/sparse_emb_outputs/v2_attn \
    --run_name v2-attn-qwen3-0.6b \
    --arm v2 \
    --K 4096 \
    --d_x 128 \
    --d_k 64 \
