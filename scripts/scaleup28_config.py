...
DATA28 = Path('/mnt/local/_data/deep-llms_th2/ccm/scaleup28_v3_20260915_a01')
OUT = Path('/mnt/local/_outputs/deep-llms_th2/ccm_scaleup28_phase_a_20260915_a01')
SESSION = 'ccm_scaleup28_phase_a_20260915_a01'
