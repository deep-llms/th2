...
The template has no initialized Git repository and no configured remotes.
Do not reuse another project's origin URL or infer an execution target.
...
Configure these from the user's project settings. Some existing deployments
