#1 +120+a
#th2-swt-next-capacity-eval98-diag294-ft126-20260910-a01
set -euo pipefail
cd /mnt/local/deep-llms_th2

TASK_RUN_ROOT=/mnt/local/_outputs/deep-llms_th2/swt/next_capacity_eval98_diag294_ft126_20260910_a01
TASK_BURN=/tmp/llm_pretrain_burn.py
TASK_BURN_PYTHON=/usr/bin/python3
TASK_BURN_PORT=29583
TASK_BURN_SESSION=swt_burn_next_capacity_eval_20260910_a01
...
# Stop only the eight freshly revalidated workers of the known current burn.
