#1 +60+a
#th2-joint-v2-eight-gpu-20260923-a03
set -euo pipefail
...
PYTHONPATH="$PWD" /usr/bin/python3 -u -m scripts.reclaim_b200_burn_20260923 --authorized-stop   --output /mnt/local/_outputs/@PROJECT@/joint-v2-burn-stop-20260923-a03.json
